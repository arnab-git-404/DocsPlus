  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        {/* Watermark */}
        {data.watermark && (
          <Text style={styles.watermark}>SALARY SLIP</Text>
        )}
        ...
        <View style={styles.header}>
          ...
          {data.company.website && (
            <Text style={styles.companyDetails}>Website: {data.company.website}</Text>
          )}
        </View>
        ...
        <View style={styles.table}>
          ...
          {/* Totals Row */}
          <View style={[styles.tableRow, { backgroundColor: '#e5e5e5', borderTopWidth: 2 }]}>
            <View style={[styles.tableLabelCol, styles.tableCol]}>
        ...
        <View style={styles.summarySection}>
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>{formatCurrency(data.salary.grossSalary)}</Text>
          </View>
          ...
          <View style={styles.netSalaryRow}>
            ...
            <Text style={styles.netSalaryValue}>{formatCurrency(data.salary.netSalary)}</Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.noteText}>
            All amounts are in Indian Rupees (INR). Please verify the details and contact HR for any discrepancies.
          </Text>
          ...
          {data.signature && (
            <View style={styles.signature}>
              ...
              <Text style={[styles.signatureText, { fontWeight: 'normal', fontSize: 8 }]}>
                {data.company.name}
              </Text>
            </View>
          )}
